...
(function(root){
  ...
  function reasons(page,r){
    ...
    if((page.regions||[]).some(other=>other.id!==r.id&&other.enabled&&(other.text?.trim()||other.latex?.trim())&&overlaps(box,rect(other))))hints.push('与其他文字区域相碰');
    return hints;
  }
  function signature(page,r){
    ...
    const others=(page.regions||[]).filter(o=>o.id!==r.id&&o.enabled&&(o.text?.trim()||o.latex?.trim())&&overlaps(rect(r),rect(o)))
      .map(o=>[o.id,o.x,o.y,o.font_size,o.text,o.latex]);
