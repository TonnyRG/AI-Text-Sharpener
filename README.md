...
**框选多个区域：** 在画布或周围空白处按住左键拖动，选中完全包含在框内的文字；反向拖动同样有效，旋转文字按实际四角判断。Shift / Ctrl 点击可增减选择，点击空白或按 Esc 取消。选中后可整体移动、方向键微调或 Delete 删除；锁定区域不参与移动或删除，保留原图的区域不参与移动。整体移动和删除均可撤销。
